...
It uses a function to calculate a total from a quantity
and price. */
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    print "<p>Your total comes to $<span style=\"font-weight: bold;\">$total
		   </span>, including the $tax percent tax rate.</p>";
