...
HTML form. This script takes text input
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
    ...
    quotation here.') ) { // Need something to write.
    ...
    if (is_writable($file)) {
        ...
        file_put_contents($file,
            $_POST['quote'] . PHP_EOL,
            FILE_APPEND | LOCK_EX); // Write the data.
           // Print a message:
        ...
        file.
        print '<p style="color:
            red;">Your quotation could
            not be stored due to a system error.</p>';
        }
...
method="post">
    <textarea name="quote" rows="5" cols="30">Enter your quotation
    here.</textarea><br> <input type="submit" name="submit"
